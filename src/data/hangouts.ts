...
export const HANGOUT_QUESTS: Quest[] = [
  ...
  // Real SA dive sites, cost = typical per-person price (see ticketInfo.price for
  // the full range) sourced from operator rates surveyed Aug 2026. Booking links
  // go to the main shop page, not a specific SKU.
  q({
    id: 'scuba-gansbaai',
    title: 'Shark Cage Diving — Gansbaai', emoji: '🦈',
    category: 'adventure', province: 'WC', city: 'Gansbaai', region: 'overberg',
    lat: -34.6445, lng: 20.2345,
    durationMin: 240, cost: 1800, players: [1, 6], difficulty: 2,
    vibe: ['outdoors', 'competitive', 'entertainment'],
    description: "The world capital of great-white encounters — a 3.5-hour boat trip to Shark Alley (between Dyer Island and Geyser Rock), with a marine biologist on board and cage time with the locals. No certification needed; breath-hold only.",
    completionLine: "You shared a cage with a great white and lived to brag about it. The seals filed a formal complaint about your presence.",
    xp: 320, trending: true,
    ticketInfo: {
      required: true,
      price: 'R1,500–R2,500 per person (wetsuit, refreshments included)',
      where: [
        { label: 'Online at Gansbaai Shark Tours', url: 'https://www.gansbaisharktours.co.za/' },
        { label: 'Online at Great White Fears', url: 'https://www.greatwhitefears.co.za/' },
        { label: 'At the Kleinbaai harbour ticket office' },
      ],
      url: 'https://www.gansbaisharktours.co.za/',
    },
    tags: ['shark cage', 'gansbaai', 'great white', 'overberg'],
  }),
  q({
    id: 'scuba-sodwana', title: 'Sodwana Bay Coral Reefs', emoji: '🐠',
    category: 'adventure', province: 'KZN', city: 'Sodwana Bay', region: 'vryheid-coast',
    lat: -27.3472, lng: 32.6692,
    durationMin: 480, cost: 1500, players: [1, 4], difficulty: 4,
    vibe: ['outdoors', 'competitive'],
    description: "Africa's southernmost coral reefs inside iSimangaliso Wetland Park — two-tank days over reefs that drop into blue holes. Ragged-tooth sharks in winter, turtles year-round, and water so clear you'll forget to breathe. Certification required; gear hire included in most packages.",
    completionLine: "You dived the southernmost reef on Earth and saw a turtle that looked judging. The coral remembered you.",
    xp: 420, trending: true,
    ticketInfo: {
      required: true,
      price: 'R1,500–R2,200 per person (two-tank day, gear included)',
      where: [
        { label: 'Online at African Dive Adventures', url: 'https://www.africandive.co.za/sodwana-bay/' },
        { label: 'Online at Pisces Diving Sodwana Bay', url: 'https://www.piscesdiving.co.za/' },
        { label: 'At the Sodwana Bay lodges (Coral Sea or similar)' },
      ],
      url: 'https://www.africandive.co.za/sodwana-bay/',
    },
    tags: ['scuba', 'reef', 'sodwana', 'turtles', 'isimagaliso'],
  }),
  q({
    id: 'scuba-aliwal',
    title: 'Aliwal Shoal Adventures', emoji: '🦈',
    category: 'adventure', province: 'KZN', city: 'Umkomaas', region: 'south-coast',
    lat: -30.1900, lng: 30.7700,
    durationMin: 420, cost: 1500, players: [1, 4], difficulty: 4,
    vibe: ['outdoors', 'competitive'],
    description: "RIB launch to the legendary Aliwal Shoal — ragged-tooth aggregations (July–Oct), tiger sharks (Nov–Mar), and humpback whales on migration. Warm water, big animals, real surface intervals. Certification required.",
    completionLine: "You did the Aliwal shuffle: dive with a ragged-tooth, surface to a whale song, repeat. The ocean signed your logbook.",
    xp: 400, trending: true,
    ticketInfo: {
      required: true,
      price: 'R1,500–R2,000 per person (two-tank trip, gear included)',
      where: [
        { label: 'Online at Blue Fin Divers', url: 'https://www.bluefindivers.co.za/' },
        { label: 'Online at Aliwal Shoal Safaris', url: 'https://www.aliwalshoalsafaris.co.za/' },
        { label: 'At the Umkomaas launching slip' },
      ],
      url: 'https://www.bluefindivers.co.za/',
    },
    tags: ['scuba', 'ragged-tooth', 'aliwal shoal', 'sharks'],
  }),
  q({
    id: 'scuba-cape-town',
    title: 'Cape Town Kelp & Seals', emoji: '🦭',
    category: 'adventure', province: 'WC', city: 'Cape Town', region: 'cape-town',
    lat: -33.9249, lng: 18.4241,
    durationMin: 240, cost: 900, players: [1, 4], difficulty: 3,
    vibe: ['outdoors', 'competitive'],
    description: "Cold-water diving in False Bay — kelp forests at Long Beach (Simon's Town), cape fur seals at Strawberry Rock, and the chance to spot pyjama sharks. 7mm suit or drysuit essential (water 10–16°C). Certification required; drysuit rental available.",
    completionLine: "You dove kelp forests and played with seals in the Atlantic. Your lips turned blue and your soul turned green.",
    xp: 300,
    ticketInfo: {
      required: true,
      price: 'R900–R1,800 per person (single/two-tank, gear & drysuit rental extra)',
      where: [
        { label: 'Online at Ollava Scuba', url: 'https://www.ollavascuba.co.za/' },
        { label: 'Online at Harbour Dive Centre', url: 'https://www.harbourdivecentre.co.za/' },
        { label: 'At the Simon’s Town launch site' },
      ],
      url: 'https://www.ollavascuba.co.za/',
    },
    tags: ['scuba', 'kelp forest', 'seals', 'cape town', 'cold water'],
  }),
  q({
    id: 'scuba-mossel-bay',
    title: 'Mossel Bay Great White', emoji: '🦈',
    category: 'adventure', province: 'WC', city: 'Mossel Bay', region: 'garden-route',
    lat: -34.1800, lng: 22.1300,
    durationMin: 240, cost: 2200, players: [1, 6], difficulty: 2,
    vibe: ['outdoors', 'competitive', 'entertainment'],
    description: "The Gondwana coast's reliable great-white season — smaller groups than Gansbaai, boat trips to the Shallows, and cage diving with the ocean's apex predator. No certification needed; breath-hold only.",
    completionLine: "You dove with great whites on the Garden Route and somehow convinced a seal to pose for photos. Lucky.",
    xp: 340, trending: true,
    ticketInfo: {
      required: true,
      price: 'R2,200–R3,500 per person (wetsuit, transport & light meal included)',
      where: [
        { label: 'Online at Oceans Edge Adventures', url: 'https://www.oceansedgeadventures.co.za/' },
        { label: 'Online at Great White Upclose', url: 'https://www.greatwhiteupclose.co.za/' },
        { label: 'At the Mossel Bay harbour ticket office' },
      ],
      url: 'https://www.oceansedgeadventures.co.za/',
    },
    tags: ['scuba', 'great white', 'mossel bay', 'garden route', 'cage diving'],
  }),
  q({
    id: 'scuba-jeffreys-bay',
    title: 'Jeffreys Bay Reef & Wreck', emoji: '🐡',
    category: 'adventure', province: 'EC', city: 'Jeffreys Bay', region: 'eastern-cape',
    lat: -34.0150, lng: 24.9200,
    durationMin: 300, cost: 1200, players: [1, 4], difficulty: 3,
    vibe: ['outdoors', 'competitive'],
    description: "Warm Indian Ocean diving on the south coast — reef dives over soft coral and the occasional wreck, with dolphins and the chance of a late-season ragged-tooth. Warmest water in SA (22–27°C). Certification required; gear hire included.",
    completionLine: "You dived warm water, rode a reef, and waved at a dolphin. The ocean nodded back. Proper South Africa.",
    xp: 280,
    ticketInfo: {
      required: true,
      price: 'R1,200–R1,800 per person (two-tank day, gear included)',
      where: [
        { label: 'Online at Dive Site Jeffreys Bay', url: 'https://www.divesite.co.za/' },
        { label: 'Online at JBay Dive Centre', url: 'https://www.jbaydivecentre.co.za/' },
        { label: 'At the JBay harbour slipway' },
      ],
      url: 'https://www.divesite.co.za/',
    },
